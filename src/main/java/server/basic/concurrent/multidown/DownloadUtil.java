 ...
 * 
 */
package server.basic.concurrent.multidown;
...
public class DownloadUtil {
    ...
    public static void main(String[] args) {
        String path = "https://file.leke.cn/group2/M00/C9/9B/wKjIG1oiDUaAAtCOAUJBmslGkmY176.zip";
        String targetPath = "/Users/henry/Desktop/wKjIG1oiDUaAAtCOAUJBmslGkmY176.zip";
